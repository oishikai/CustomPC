...
enum category: String {
    ...
    func specItems() -> [String] {
        ...
        case .graphicsCard:
            return ["基本スペック","搭載チップ", "メモリ", "CUDAコア数", "SP数", "メモリバス", "メモリクロック", "バスインターフェイス", "解像度", "モニタ端子", "冷却タイプ", "ファンレス", "セミファンレス", "最大ディスプレイ接続台数", "消費電力", "その他機能","ロープロファイル対応", "4K対応", "補助電源", "SLI", "CrossFire", "LED制御機能", "DirectX", "OpenGL", "サイズ","本体(幅x高さx奥行)", "ラジエータ(幅x高さx奥行)"]
        case .ssd:
